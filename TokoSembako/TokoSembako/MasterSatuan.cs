...
{
    public partial class MasterSatuan : Form
    {
        String ID;
        ...
        {
            InitializeComponent();
            string q = "SELECT TOP 1 id_satuan FROM Satuan ORDER BY id_satuan DESC";
            ID = idotomatis("STN", q);
        }
        ...
        private void btnTambah_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand insert = new SqlCommand("sp_InsertSatuan", connection);
            ...
            {
                insert.Parameters.AddWithValue("id_satuan", ID);
                insert.Parameters.AddWithValue("satuan", txtsatuan.Text);
